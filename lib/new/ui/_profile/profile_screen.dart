              ...
              children: [
                ...
                const ProfileListTileItem(
                 ...
                 ProfileListTileItem(
                    icon: Icons.email,
                    title: "تواصل معنا",
                    onClicked: ()=>navigateTo(ContactUsScreen()),
                ),
                const ProfileListTileItem(
      ...
      builder: (context) {
        return Directionality(
          ...
          child: AlertDialog(
            ...
            title: const Text("حذف الموعد المحجوز"),
            content: const Text("أنت علي وشك حذف الحجز ، هل تريد المتابعة ؟"),
            actions: [
              AppButton(
                  title: "لا",
...
void openFacebook() async {
  String? pageId = AppCache.instance.getClinicInfo()?.data?.faceBook;
...
void openMap() async {
  ...
  if (await MapLauncher.isMapAvailable(MapType.google) ?? false) {
    await MapLauncher.showMarker(
      ...
      title: "El Batool Clinic Location",
    );
  } else {
    print("lat");
    print(lat);
